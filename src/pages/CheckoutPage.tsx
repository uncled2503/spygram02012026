...
const CheckoutPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-300 font-sans pb-10">
      ...
      {/* Banner Principal e Reviews (Claro com Blur) */}
      <div className="w-full relative flex flex-col items-center pt-8 pb-8 px-4 border-b border-gray-800 overflow-hidden bg-white">
        {/* Efeitos de fundo claro e blur */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#f8f9fa] to-[#e9ecef]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.9)_0%,transparent_100%)] blur-xl"></div>
